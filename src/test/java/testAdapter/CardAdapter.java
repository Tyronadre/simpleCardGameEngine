...
public class CardAdapter {
    ...
    public static void event(Card card, Player activePlayer, Player cardOwner, int roll, Game game) {
        ((PlayingCard) card).event(new CardEvent((PlayerImpl) cardOwner,(PlayerImpl) activePlayer, roll, (GameBoard) game.getActiveGameBoard(), card));
    }
}
